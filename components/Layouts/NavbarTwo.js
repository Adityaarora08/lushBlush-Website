        ...
        <nav className="navbar navbar-expand-md navbar-light">
          <div className="container-fluid">
            <Link href="/" className="navbar-brand" >
              ...
              <img src="/images/logoL&B.svg" className="black-logo" alt="logo" style={{height: '55px', width: '55px'}} />
              <img
                src="/images/logoL&B.svg"
                style={{height: '55px', width: '55px'}}
                className="white-logo"
                alt="logo"
              />
              <div style={{display: 'flex', flexDirection: 'row',alignItems:'center', justifyContent: 'center'}}><span style={{color: 'red',marginLeft: '5px'}}>L</span><span>&</span><span style={{color: 'blue'}}>B </span><span style={{marginLeft: '5px'}}>Pharmaceuticals</span></div>
              </div>
            </Link>
